...
const String facevgg = "facevgg";
const String pedrosModel = "pedrosModel";
...
class _MyAppState extends State<MyApp> {
  ...
  Future loadModel() async {
    ...
    try {
      ...
      switch (_model) {
        ...
        case facevgg:
        res = await Tflite.loadModel(
            model: "assets/trained_vggface.tflite",
            labels: "assets/trained_vggface.txt"
            // useGpuDelegate: true,
          );
          break;
        case pedrosModel:
  ...
  Widget build(BuildContext context) {
    ...
    if (_model == mobile || _model == facevgg || _model == pedrosModel) {
